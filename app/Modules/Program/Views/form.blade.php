...
<ul class="breadcrumb w3-card">
  ...
  <li><a href="/program"><i class="fa fa-pencil"> รายการข้อมูลการสอน</i></a></li>
    @if(isset($programs))
        <li><i class="fa fa-edit"> แก้ไขข้อมูลการสอน</i></li>
    @else
        <li><i class="fa fa-plus"> เพิ่มรายการข้อมูการสอน</i></li>
    @endif
</ul>
<div class="row">
        <div class="col-md-1">   
