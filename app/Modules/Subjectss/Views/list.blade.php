...
<ul class="breadcrumb w3-card">
  ...
  <li><i class="fa fa-book"> รายการข้อมูลวิชา</i></li>
</ul>
<div class="container">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-10">
            <div class="panel panel-primary w3-card">
                <div class="panel-heading">รายการข้อมูลวิชา  
                @if(CurrentUser::permission([]))
                <a class="btn btn-default pull-right" href="/subjectss/create" style="padding-top: 2px;padding-bottom: 2px;" data-toggle="tooltip" title="เพิ่มข้อมูล"><i class="fa fa-plus"></i></a>
                @endif
                </div>
                <div class="panel-body">
